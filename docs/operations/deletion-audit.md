...
| Clean Missing Payloads | Manual, approved dry run | Deletes only mounts whose local streaming metadata is absent; verified Arr files request replacement without blocklisting [since 1.3.0](https://github.com/infinidysk/infinidysk/releases/tag/v1.3.0){ .nzbdav-since } |
